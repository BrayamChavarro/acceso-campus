                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border-t-4 border-blue-500">
                    ...
                    {!qrData ? (
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Documento de Identidad (CC) (opcional)</label>
                                <div className="mt-1">
                                    <input 
                                        type="text" 
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Código de Estudiante (opcional)</label>
                                <div className="mt-1">
                                    <input 
                                        type="text" 
                                        className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ...
                            <div>
                                <button 
                                    type="submit" 
                                    disabled={loading || (!formData.documento_identidad?.trim() && !formData.codigo_estudiante?.trim())}
